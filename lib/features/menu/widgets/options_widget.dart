...
class _OptionsWidgetState extends State<OptionsWidget> {
  ...
  List<String> _buildCategoryItems(
    List<OnlyCategoryModel>? directory,
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<CategoryProvider, ProfileProvider>(
        builder: (context, categoryProvider, profileProvider, _) {
                      ...
                      child: Column(
                        children: [
                          PortionWidget(
                            ...
                            onRoute: () => RouterHelper.getProfileRoute('main'),
                          ),
                          ...
                          Consumer<ProfileProvider>(
                            builder: (context, profileProvider, child) {
                              final String applicationStatus = profileProvider
                                      .userInfoModel?.freelancerRequestStatus ??
                                  '';
                              final String applicationStatusNote =
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        getTranslated('menu_more', context)!,
                        style: rubikSemiBold.copyWith(
                          fontSize: Dimensions.fontSizeLarge,
                        ),
                      ),
