                                ...
                                children: [
                                  InkWell(
                                    child: Container(
                                      ...
                                      child: Icon(
                                        reviewProvider.rateIndex >= i
                                            ? Iconsax.star1
                                            : Iconsax.star, // Use star icon
                                    ...
                                    onTap: () {
                                      reviewProvider.setRatingIndex(
                                          i); // Set rating index (0-based)
                                    },
                                  ),
                                ],
                              ),
                            ...
                            ? Padding(
                                ...
                                child: CustomButtonWidget(
                                  btnTxt: getTranslated(
                                      reviewProvider.isReviewSubmitted
                                          ? 'submitted'
                                          : 'submit',
                                      context),
                                  onTap: reviewProvider.isReviewSubmitted
                                      ? null
                                      : () {
                                          if (reviewProvider.rateIndex == -1) {
                                            ...
                                            ReviewBody reviewBody = ReviewBody(
                                              ...
                                              rating:
                                                  reviewProvider.rateIndex + 1,
                                              comment: _controller.text,
                                              bookingId: widget.bookingID,
                                            );
                                            reviewProvider
                                                .submitBookingReview(reviewBody)
                                                .then((value) {
                                              if (value.isSuccess) {
                                                showCustomSnackBarHelper(
                                                    value.message,
