...
class ExistingAccountBottomSheet extends StatefulWidget {
  ...
  const ExistingAccountBottomSheet(
      {super.key, required this.userInfoModel, required this.loginMedium});
                ...
                TextSpan(
                  text: getTranslated(
                      widget.loginMedium == FromPage.otp.name
                          ? 'it_looks_like_the_phone'
                          : 'it_looks_like_the_email',
                      context)!,
                  style: rubikRegular.copyWith(
                    fontSize: Dimensions.fontSizeDefault,
                      ...
                      authProvider
                        ...
                        if (responseModel != null &&
                          ...
                          RouterHelper.getOtpRegistrationScreen(
                            ...
                            userName: "${widget.userInfoModel.name}",
                          );
                        }
                      });
                    }
                    ...
                    if (authProvider.isPhoneNumberVerificationButtonLoading) {
                      ...
                      authProvider
                        ...
                        if (responseModel != null &&
                          ...
                          String? countryCode =
                              NumberCheckerHelper.getCountryCode(
                                  widget.userInfoModel.phone);
