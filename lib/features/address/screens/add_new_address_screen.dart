...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  _initLoading() async {
    ...
    if (widget.isEnableUpdate && widget.address != null) {
      ...
      locationProvider.onChangeDefaultStatus(widget.address?.isDefault ?? false,
          isUpdate: false);
      ...
      if (authProvider.isLoggedIn()) {
        ...
        _contactPersonNameController.text = userModel?.name ?? '';
        _contactPersonNumberController.text = (code != null
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (CustomAppBarWidget(
        ...
        context: context,
        title: getTranslated(
            widget.isEnableUpdate ? 'update_address' : 'add_delivery_info',
            context),
        centerTitle: true,
                          ...
                          child: Center(
                            ...
                            child: Column(children: [
                              ...
                              Row(children: [
                                ...
                                Text(
                                  getTranslated(
                                      'save_this_as_your_default_address',
                                      context)!,
