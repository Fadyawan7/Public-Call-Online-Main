...
class AddressCustomPrinterWidget extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint1Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.05864333, size.height * 0.9286671),
        Offset(size.width * 0.05864333, size.height * 0.7958367),
    ...
    paint2Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.05495083, size.height * 0.9286671),
        Offset(size.width * 0.05495083, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint3Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.1169353, size.height * 0.9286671),
        Offset(size.width * 0.1169353, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint4Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.1132428, size.height * 0.9286671),
        Offset(size.width * 0.1132428, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint5Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.2644689, size.height * 0.9286671),
        Offset(size.width * 0.2644689, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint6Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.2246725, size.height * 0.9196683),
        Offset(size.width * 0.2246725, size.height * 0.6454862),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint7Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.1803822, size.height * 0.9286671),
        Offset(size.width * 0.1803822, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint8Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.3314889, size.height * 0.9286671),
        Offset(size.width * 0.3314889, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint9Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.3443528, size.height * 0.9286671),
        Offset(size.width * 0.3443528, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint10Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.4602250, size.height * 0.9442236),
        Offset(size.width * 0.4602250, size.height * 0.8113945),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint11Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.4530444, size.height * 1.024202),
        Offset(size.width * 0.4530444, size.height * 0.5865440),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint12Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.3709806, size.height * 0.9286671),
        Offset(size.width * 0.3709806, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint13Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.3611056, size.height * 1.008229),
        Offset(size.width * 0.3611056, size.height * 0.6786206),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint15Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.2875028, size.height * 0.9286671),
        Offset(size.width * 0.2875028, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint18Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.2752328, size.height * 0.9286658),
        Offset(size.width * 0.2752328, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint19Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.5568806, size.height * 0.9286658),
        Offset(size.width * 0.5568806, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint20Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.6354750, size.height * 0.9286671),
        Offset(size.width * 0.6354750, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint21Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.6266944, size.height * 1.010405),
        Offset(size.width * 0.6266944, size.height * 0.7117462),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint22Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7260500, size.height * 0.9286658),
        Offset(size.width * 0.7260500, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint23Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7188167, size.height * 1.009345),
        Offset(size.width * 0.7188167, size.height * 0.8024912),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint24Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.6476500, size.height * 0.9286671),
        Offset(size.width * 0.6476500, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint25Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7619361, size.height * 0.9286658),
        Offset(size.width * 0.7619361, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint26Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7578000, size.height * 0.9286658),
        Offset(size.width * 0.7578000, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint27Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7482056, size.height * 0.9286658),
        Offset(size.width * 0.7482056, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint28Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9024639, size.height * 0.9286671),
        Offset(size.width * 0.9024639, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint29Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9079528, size.height * 0.9286671),
        Offset(size.width * 0.9079528, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint30Fill.shader = ui.Gradient.linear(
        Offset(size.width * -0.04500583, size.height * 0.9286658),
        Offset(size.width * -0.04500583, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint31Fill.shader = ui.Gradient.linear(
        Offset(size.width * -0.4142667, size.height * 0.9286658),
        Offset(size.width * -0.4142667, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint32Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.02191169, size.height * 0.9395415),
        Offset(size.width * 0.02191169, size.height * 0.7430477),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint33Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.03188333, size.height * 0.7163480),
        Offset(size.width * 0.005675694, size.height * 0.7350201),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint34Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.07978139, size.height * 0.9933731),
        Offset(size.width * 0.07978139, size.height * 0.6820214),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint35Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.03828500, size.height * 0.7261156),
        Offset(size.width * 0.07758972, size.height * 0.7538430),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint36Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.09654472, size.height * 0.7440779),
        Offset(size.width * 0.1358494, size.height * 0.7718053),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint37Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.1380844, size.height * 0.9735540),
        Offset(size.width * 0.1380844, size.height * 0.7271445),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint38Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.04088389, size.height * 0.9286658),
        Offset(size.width * 0.04088389, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint39Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.02446736, size.height * 0.9904912),
        Offset(size.width * 0.02446736, size.height * 0.8331859),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint40Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.1432822, size.height * 1.059121),
        Offset(size.width * 0.1432822, size.height * 0.7180000),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint41Fill.shader = ui.Gradient.linear(
        Offset(size.width * 1.002417, size.height * 0.9286671),
        Offset(size.width * 1.002417, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint42Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.3083472, size.height * 0.9949322),
        Offset(size.width * 0.3083472, size.height * 0.6683631),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint43Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.5473083, size.height * 0.8859397),
        Offset(size.width * 0.5473083, size.height * 0.6346683),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint44Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.5943056, size.height * 0.9286658),
        Offset(size.width * 0.5943056, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint45Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.6025028, size.height * 1.017138),
        Offset(size.width * 0.6025028, size.height * 0.7340553),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint46Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.6921222, size.height * 1.087643),
        Offset(size.width * 0.6921222, size.height * 0.7335063),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint47Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.8457333, size.height * 0.9286658),
        Offset(size.width * 0.8457333, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint48Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.8885056, size.height * 1.076077),
        Offset(size.width * 0.8885056, size.height * 0.7727035),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint49Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7832917, size.height * 1.117926),
        Offset(size.width * 0.7832917, size.height * 0.6404761),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint50Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.7704278, size.height * 0.7791884),
        Offset(size.width * 0.7704278, size.height * 0.7702048),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint51Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9863028, size.height * 1.039408),
        Offset(size.width * 0.9863028, size.height * 0.6444171),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint52Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9544444, size.height * 0.9846156),
        Offset(size.width * 0.9544444, size.height * 0.6826394),
        [shadowColor, secenderyColor],
        [0, 0.75]);
    ...
    paint53Fill.shader = ui.Gradient.linear(
        Offset(size.width * 1.084478, size.height * 0.9286658),
        Offset(size.width * 1.084478, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint54Fill.shader = ui.Gradient.linear(
        Offset(size.width * 1.021656, size.height * 0.9286658),
        Offset(size.width * 1.021656, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint55Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9288444, size.height * 0.9286658),
        Offset(size.width * 0.9288444, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint56Fill.shader = ui.Gradient.linear(
        Offset(size.width * 1.016839, size.height * 0.9286671),
        Offset(size.width * 1.016839, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint57Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9783417, size.height * 0.9286671),
        Offset(size.width * 0.9783417, size.height * 0.7958367),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint58Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9624250, size.height * 0.9286658),
        Offset(size.width * 0.9624250, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    paint59Fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.9679056, size.height * 0.9286658),
        Offset(size.width * 0.9679056, size.height * 0.7958354),
        [shadowColor, primaryColor],
        [0, 0.75]);
    ...
    path_75.cubicTo(
        ...
        size.height * 0.5530490,
        size.width * 0.6542000,
        size.height * 0.5431834,
        size.width * 0.6273139,
        size.height * 0.5431834);
    path_75.cubicTo(
        size.width * 0.6004250,
        size.height * 0.5431834,
        size.width * 0.5786250,
        size.height * 0.5530490,
        size.width * 0.5786250,
        size.height * 0.5652186);
    path_75.cubicTo(
        size.width * 0.5786250,
        size.height * 0.5659234,
        size.width * 0.5787028,
        size.height * 0.5666244,
        size.width * 0.5788417,
        size.height * 0.5673153);
    path_75.cubicTo(
        size.width * 0.5784000,
        size.height * 0.5810829,
        size.width * 0.6273139,
        size.height * 0.6087575,
        size.width * 0.6273139,
        size.height * 0.6087575);
    path_75.cubicTo(
        size.width * 0.6273139,
        size.height * 0.6087575,
        size.width * 0.6762389,
        size.height * 0.5810829,
        size.width * 0.6757833,
        size.height * 0.5673153);
    path_75.cubicTo(
        size.width * 0.6759250,
        size.height * 0.5666244,
        size.width * 0.6760000,
        size.height * 0.5659234,
        size.width * 0.6760000,
    ...
    path_75.cubicTo(
        ...
        size.height * 0.5729761,
        size.width * 0.6101722,
        size.height * 0.5695013,
        size.width * 0.6101722,
        size.height * 0.5652186);
    path_75.cubicTo(
        size.width * 0.6101722,
        size.height * 0.5609347,
        size.width * 0.6178500,
        size.height * 0.5574598,
        size.width * 0.6273139,
        size.height * 0.5574598);
    path_75.cubicTo(
        size.width * 0.6367778,
        size.height * 0.5574598,
        size.width * 0.6444556,
        size.height * 0.5609347,
        size.width * 0.6444556,
        size.height * 0.5652186);
    path_75.cubicTo(
    ...
    path_76.cubicTo(
        size.width * 0.2763806,
        size.height * 0.5918844,
        size.width * 0.2623244,
        size.height * 0.5855226,
        size.width * 0.2449875,
        size.height * 0.5855226);
    path_76.cubicTo(
        size.width * 0.2276503,
        size.height * 0.5855226,
        size.width * 0.2135944,
        size.height * 0.5918844,
        size.width * 0.2135944,
        size.height * 0.5997312);
    path_76.cubicTo(
        size.width * 0.2135944,
        size.height * 0.6001859,
        size.width * 0.2136378,
        size.height * 0.6006369,
        size.width * 0.2137353,
        size.height * 0.6010829);
    path_76.cubicTo(
        size.width * 0.2134428,
        size.height * 0.6099585,
        size.width * 0.2449875,
        size.height * 0.6278028,
        size.width * 0.2449875,
        size.height * 0.6278028);
    path_76.cubicTo(
        size.width * 0.2449875,
        size.height * 0.6278028,
        size.width * 0.2765214,
        size.height * 0.6099636,
        size.width * 0.2762397,
        size.height * 0.6010829);
    path_76.cubicTo(
        size.width * 0.2763372,
        size.height * 0.6006369,
        size.width * 0.2763806,
        size.height * 0.6001859,
        size.width * 0.2763806,
    ...
    path_76.cubicTo(
        size.width * 0.2388800,
        size.height * 0.6047349,
        size.width * 0.2339311,
        size.height * 0.6024950,
        size.width * 0.2339311,
        size.height * 0.5997312);
    path_76.cubicTo(
        size.width * 0.2339311,
        size.height * 0.5969661,
        size.width * 0.2388800,
        size.height * 0.5947274,
        size.width * 0.2449875,
        size.height * 0.5947274);
    path_76.cubicTo(
        size.width * 0.2510950,
        size.height * 0.5947274,
        size.width * 0.2560436,
        size.height * 0.5969661,
        size.width * 0.2560436,
        size.height * 0.5997312);
    path_76.cubicTo(
    ...
    path_77.cubicTo(
        size.width * 0.9340861,
        size.height * 0.5487362,
        size.width * 0.9171806,
        size.height * 0.5410854,
        size.width * 0.8963250,
        size.height * 0.5410854);
    path_77.cubicTo(
        size.width * 0.8754694,
        size.height * 0.5410854,
        size.width * 0.8585639,
        size.height * 0.5487362,
        size.width * 0.8585639,
        size.height * 0.5581746);
    path_77.cubicTo(
        size.width * 0.8585639,
        size.height * 0.5587236,
        size.width * 0.8586194,
        size.height * 0.5592676,
        size.width * 0.8587389,
        size.height * 0.5598028);
    path_77.cubicTo(
        size.width * 0.8583917,
        size.height * 0.5704761,
        size.width * 0.8963250,
        size.height * 0.5919372,
        size.width * 0.8963250,
        size.height * 0.5919372);
    path_77.cubicTo(
        size.width * 0.8963250,
        size.height * 0.5919372,
        size.width * 0.9342583,
        size.height * 0.5704761,
        size.width * 0.9339111,
        size.height * 0.5598028);
    path_77.cubicTo(
        size.width * 0.9340194,
        size.height * 0.5592676,
        size.width * 0.9340861,
        size.height * 0.5587236,
        size.width * 0.9340861,
    ...
    path_77.cubicTo(
        ...
        size.height * 0.5641935,
        size.width * 0.8830278,
        size.height * 0.5614975,
        size.width * 0.8830278,
        size.height * 0.5581746);
    path_77.cubicTo(
        size.width * 0.8830278,
        ...
        size.width * 0.8889833,
        size.height * 0.5521570,
        size.width * 0.8963250,
        size.height * 0.5521570);
    path_77.cubicTo(
        size.width * 0.9036667,
        size.height * 0.5521570,
        size.width * 0.9096222,
        size.height * 0.5548518,
        size.width * 0.9096222,
        size.height * 0.5581746);
    path_77.cubicTo(
    ...
    path_78.cubicTo(
        size.width * 0.8577083,
        size.height * 0.6951759,
        size.width * 0.8491639,
        size.height * 0.6913141,
        size.width * 0.8386389,
        size.height * 0.6913141);
    path_78.cubicTo(
        size.width * 0.8281139,
        size.height * 0.6913141,
        size.width * 0.8195694,
        size.height * 0.6951809,
        size.width * 0.8195694,
        size.height * 0.6999447);
    path_78.cubicTo(
        size.width * 0.8195694,
        size.height * 0.7002198,
        size.width * 0.8196028,
        size.height * 0.7004937,
        size.width * 0.8196556,
        size.height * 0.7007676);
    path_78.cubicTo(
        size.width * 0.8194833,
        size.height * 0.7061595,
        size.width * 0.8386389,
        size.height * 0.7170050,
        size.width * 0.8386389,
        size.height * 0.7170050);
    path_78.cubicTo(
        size.width * 0.8386389,
        size.height * 0.7170050,
        size.width * 0.8578056,
        size.height * 0.7061646,
        size.width * 0.8576222,
        size.height * 0.7007676);
    path_78.cubicTo(
        size.width * 0.8576778,
        size.height * 0.7004987,
        size.width * 0.8577083,
        size.height * 0.7002236,
        size.width * 0.8577083,
        size.height * 0.6999447);
    path_78.close();
    path_78.moveTo(size.width * 0.8386389, size.height * 0.7029837);
    path_78.cubicTo(
        size.width * 0.8349361,
        size.height * 0.7029837,
        size.width * 0.8319250,
        size.height * 0.7016206,
        size.width * 0.8319250,
        size.height * 0.6999447);
    path_78.cubicTo(
        size.width * 0.8319250,
        size.height * 0.6982688,
        size.width * 0.8349361,
        size.height * 0.6969058,
        size.width * 0.8386389,
        size.height * 0.6969058);
    path_78.cubicTo(
        size.width * 0.8423417,
        size.height * 0.6969058,
        size.width * 0.8453528,
        size.height * 0.6982688,
        size.width * 0.8453528,
        size.height * 0.6999447);
    path_78.cubicTo(
    ...
    path_79.cubicTo(
        size.width * 0.5819389,
        size.height * 0.6263291,
        size.width * 0.5733944,
        size.height * 0.6224661,
        size.width * 0.5628694,
        size.height * 0.6224661);
    path_79.cubicTo(
        size.width * 0.5523444,
        size.height * 0.6224661,
        size.width * 0.5438000,
        size.height * 0.6263329,
        size.width * 0.5438000,
        size.height * 0.6310967);
    path_79.cubicTo(
        size.width * 0.5438000,
        size.height * 0.6313719,
        size.width * 0.5438333,
        size.height * 0.6316457,
        size.width * 0.5438861,
        size.height * 0.6319209);
    path_79.cubicTo(
        size.width * 0.5437139,
        size.height * 0.6373116,
        size.width * 0.5628694,
        size.height * 0.6481570,
        size.width * 0.5628694,
        size.height * 0.6481570);
    path_79.cubicTo(
        size.width * 0.5628694,
        size.height * 0.6481570,
        size.width * 0.5820361,
        size.height * 0.6373166,
        size.width * 0.5818528,
        size.height * 0.6319209);
    path_79.cubicTo(
        size.width * 0.5819083,
        size.height * 0.6316508,
        size.width * 0.5819389,
        size.height * 0.6313769,
        size.width * 0.5819389,
        size.height * 0.6310967);
    path_79.close();
    path_79.moveTo(size.width * 0.5628694, size.height * 0.6341357);
    path_79.cubicTo(
        size.width * 0.5591556,
        size.height * 0.6341357,
        size.width * 0.5561556,
        size.height * 0.6327739,
        size.width * 0.5561556,
        size.height * 0.6310967);
    path_79.cubicTo(
        size.width * 0.5561556,
        size.height * 0.6294209,
        size.width * 0.5591667,
        size.height * 0.6280590,
        size.width * 0.5628694,
        size.height * 0.6280590);
    path_79.cubicTo(
        size.width * 0.5665722,
        size.height * 0.6280590,
        size.width * 0.5695833,
        size.height * 0.6294209,
        size.width * 0.5695833,
        size.height * 0.6310967);
    path_79.cubicTo(
