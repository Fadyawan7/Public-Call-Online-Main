                                ...
                                builder: (context, bookingProvider, child) {
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return DateWidget(
                                        date: bookingProvider
                                            .days[index].formattedDate
                                            .toUpperCase(),
                                        title: bookingProvider.days[index].day
                                            .toString(),
                                        isSelected:
                                            bookingProvider.selectDateSlot ==
                                                    index
                                                ? true
                                                : false,
                                        onTap: () => {
                                          bookingProvider.updateDateSlot(
                                              index,
                                              bookingProvider.days[index].date
                                                  .toString()),
                                          bookingProvider.checkAvailableTimes(
                                              bookingProvider.days[index].date
                                                  .toString())
                                        },
                                      );
