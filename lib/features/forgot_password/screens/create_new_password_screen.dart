...
class CreateNewPasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWidget(context: context, title: getTranslated('create_new_password', context),titleColor: Colors.white,),
      body: SafeArea(
                         ...
                         !auth.isForgotPasswordLoading ? CustomButtonWidget(
                           ...
                           onTap: () {
                             if (_passwordController.text.isEmpty) {
                               ...
                               auth.resetPassword(emailOrPhone, resetToken, _passwordController.text, _confirmPasswordController.text, type: 'email').then((value) {
                                 if(value.isSuccess) {
                                   auth.login(emailOrPhone, _passwordController.text,'email').then((value) async {
