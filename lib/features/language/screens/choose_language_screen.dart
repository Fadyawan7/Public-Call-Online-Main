...
class _ChooseLanguageScreenState extends State<ChooseLanguageScreen> {
  ...
  void initState() {
    ...
    languageProvider.setSelectIndex(
        languageProvider
            .getLanguageIndexByCode(localizationProvider.locale.languageCode),
        isUpdate: false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    print(
        "---------------------Result : ${ModalRoute.of(context)?.settings.name == RouterHelper.languageScreen}");
    print("-----------------------CanPop : ${Navigator.canPop(context)}");
    print(
        "----------------------Result 2 is : ${(ModalRoute.of(context)?.settings.name == RouterHelper.languageScreen && !Navigator.canPop(context))}");
                  ...
                  children: [
                    ...
                    const Center(
                        child: SizedBox(
                            ...
                            height: 65,
                            child:
                                CustomAssetImageWidget(Images.chooseLanguage))),
