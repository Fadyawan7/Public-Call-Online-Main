...
class SupportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (CustomAppBarWidget(context: context,
          title: getTranslated('help_and_support', context))) as PreferredSizeWidget?,
      body: Scrollbar(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(
                          Provider.of<SplashProvider>(context, listen: false).configModel!.companyAddress!,
