...
class _MessageBodyWidgetState extends State<MessageBodyWidget> {
  ...
  void onEvent(PusherEvent event) {
    try {
      ...
      log('[Pusher] Error processing event', error: e, stackTrace: stackTrace);
    }
  }
      ...
      child: Consumer<ChatProvider>(builder: (context, chatProvider, child) {
        return Container(
          ...
          child: Column(children: [
            chatProvider.conversationList!.isEmpty && chatProvider.isLoading
                ? Expanded(
                ...
                : chatProvider.conversationList!.isEmpty &&
                    ...
                    ? Expanded(
                        child: Column(
                            ...
                            Text(getTranslated('no_message_found', context)!,
                                style: rubikSemiBold),
                            const SizedBox(
                                height: Dimensions.paddingSizeDefault),
                            Text(
                                widget.isAdmin
                                    ? "${getTranslated('start_typing_to_chat_with_restaurant', context)!} ${getTranslated('admin', context)!}"
                    ...
                    : Expanded(
                        ...
                        itemBuilder: (context, index) {
                          return MessageBubbleWidget(
                            ...
                            isMe: widget.loggedUserId ==
                                chatProvider.conversationList![index].senderId,
                          );
                        },
                      )),
                ...
                Row(children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      width: 48,
                      height: 48,
                      child: CustomAssetImageWidget(Images.image,
                          color: const Color(0xFF8696A0), fit: BoxFit.contain),
                    ),
                  ),
