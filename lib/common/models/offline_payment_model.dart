...
class OfflinePaymentModel {
  ...
  factory OfflinePaymentModel.fromRawJson(String str) =>
      OfflinePaymentModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory OfflinePaymentModel.fromJson(Map<String, dynamic> json) =>
      OfflinePaymentModel(
        id: json["id"],
        ...
        methodInformations: json["method_informations"] == null
            ? []
            : List<MethodInformation>.from(json["method_informations"]!
                .map((x) => MethodInformation.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "id": id,
        "method_name": methodName,
        "method_fields": methodFields == null
            ? []
            : List<dynamic>.from(methodFields!.map((x) => x.toJson())),
        "payment_note": paymentNote,
        "method_informations": methodInformations == null
            ? []
            : List<dynamic>.from(methodInformations!.map((x) => x.toJson())),
      };
}
...
class MethodInformation {
  ...
  factory MethodInformation.fromRawJson(String str) =>
      MethodInformation.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MethodInformation.fromJson(Map<String, dynamic> json) =>
      MethodInformation(
