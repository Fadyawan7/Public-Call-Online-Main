class ConfigModel {
  ...
  int? get maintenanceMode => _maintenanceMode;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _playStoreConfig = json['play_store_config'] != null
        ...
        : null;
    final maintenanceMode = json['maintenance_mode'];
    _maintenanceMode = maintenanceMode is bool
        ? maintenanceMode
            ? 1
            : 0
        : int.tryParse('$maintenanceMode');
