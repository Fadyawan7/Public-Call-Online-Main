  ...
  Widget build(BuildContext context) {
    return Consumer<SplashProvider>(
      builder: (context, splashProvider, _) {
        return !(splashProvider.configModel?.maintenanceMode == 1) && ( splashProvider.configModel?.companyWhatsapp != null) ?
        InkWell(
          onTap: () async {
            final String? whatsapp = splashProvider.configModel!.companyWhatsapp;
